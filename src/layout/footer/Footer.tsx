...
const footer_data: DataType[] = [
   {
      ...
      title: "Usefull Links",
      footer_link: [{ link: "/contact", link_title: "Contact us" }, { link: "/#roadMap", link_title: "How it Works" }, { link: "https://panel.capimaxinvestment.com/", link_title: "Create" }, { link: "/#investment-plans", link_title: "Explore" }, { link: "/contact", link_title: "Terms & Services" },]
   },
   {
      id: 2,
      class_name: "col-xl-3 col-lg-2 col-md-4 col-sm-6",
      title: "SOLUTIONS",
      footer_link: [{ link: "/contact", link_title: "Token Suite" }, { link: "/contact", link_title: "Ecosystem" }, { link: "/global", link_title: "Global" }, { link: "/contact", link_title: "Portal" }, { link: "/contact", link_title: "Tokenization" },]
   },
   {
      id: 3,
      class_name: "col-xl-3 col-lg-3 col-md-4 col-sm-4",
      title: "Usefull Links",
      footer_link: [{ link: "/contact", link_title: "Help Center" }, { link: "/contact", link_title: "Partners" }, { link: "/contact", link_title: "Suggestions" }, { link: "/oppotunities", link_title: "Investments" }, { link: "/contact", link_title: "Newsletters" },]
   },
]
